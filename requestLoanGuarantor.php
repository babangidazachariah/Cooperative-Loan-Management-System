...
SESSION_START(); 
	if(isset($_POST['submit'])){
		...
		if($isError == "false"){
			...
			$Sql ="UPDATE tblTempLoans SET firstGuarantor ='".$_POST['firstGuarantor']."', secondGuarantor = '".$_POST['secondGuarantor']."' WHERE staffNumber ='".$_SESSION['staffNumber']."'";
...
<body>
	<form action="requestLoanGuarantor.php" method="POST" id="requestLoanGuarantor">
		<table align ="center" >
								...
								<table border ="1" width='800' align='center' style="outset:5pt;" bgcolor="silver"><!-- body table-->
									<tr>
										<td colspan ="3" bgcolor="green" align="center" >
											<font color='white' size='7'><b>Loan Guarantor Request Form</b></font>
										</td>
									</tr>
									<tr>
										<td colspan ="3" bgcolor="green" align="center" >
											<font color='white' size='4' id='notify'>
												<?php
													print($notify);
												?>
											</font>
