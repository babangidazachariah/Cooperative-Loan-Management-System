	...
	function SubmitForm(routine){
		...
		xmlhttp.onreadystatechange = function()
		{
			...
			if((xmlhttp.readyState == 4) && (xmlhttp.status == 200))
			{
				...
				document.forms['administratorNewNews'].submit();
			}
		}
...
<body onload="InitializeNotify()">
	<form action="administratorNewNews.php" method="POST" id='administratorNewNews'>
		<table align ="center" >
						...
						<tr>
							<td align='center'>
								<table bgcolor='silver' border="1" width="650" style ="border-style: double; border-color: green; border-width: 4;">
									...
									<tr>
										<td></td><td align="right"><b>Return to <a href='administratorHome.php'>Administrator's Home Here!</b></td>
									</tr> 
								</table>
